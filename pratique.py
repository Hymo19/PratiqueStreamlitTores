...
st.title("de Application de manipulation et visualisation des données de MANINDJI Tores")
...
# Ajouter un footer avec le copyright
st.markdown("---")
st.markdown("**Réalisé par MANINDJI D.S.TORES HYMELD** © 2024")
